...
/obj/item/shield/riot/buckler/stop
	...
	armor = list("melee" = 65, "bullet" = 60, "laser" = 65, "energy" = 30, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 40)
	max_integrity = 300
	slowdown = 0
...
/obj/item/shield/riot/legion
	...
	armor = list("melee" = 70, "bullet" = 60, "laser" = 65, "energy" = 30, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 40)
	force = 13
	slowdown = 0
	max_integrity = 500
...
/obj/item/shield/riot/scrapshield
	...
	block_parry_data = /datum/block_parry_data/shield/scrap
	armor = list("melee" = 65, "bullet" = 60, "laser" = 65, "energy" = 30, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 40)
	max_integrity = 500
	slowdown = 0.1
	force = 13
